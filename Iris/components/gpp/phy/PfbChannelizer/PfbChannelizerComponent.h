/**
 * \file components/gpp/phy/PfbChannelizer/PfbChannelizerComponent.h
 * \version 1.0
 *
 * \section COPYRIGHT
 *
 ...
 * \section DESCRIPTION
 *
 * A polyphase filterbank channelizer using liquid-dsp. For more
 * info see https://github.com/jgaeddert/liquid-dsp.
 */

#ifndef PHY_PFBCHANNELIZERCOMPONENT_H_
#define PHY_PFBCHANNELIZERCOMPONENT_H_
  ...
  : public PhyComponent
{
 public:
  ...
  PfbChannelizerComponent(std::string name);
  ~PfbChannelizerComponent();
...
#endif // PHY_PFBCHANNELIZERCOMPONENT_H_
